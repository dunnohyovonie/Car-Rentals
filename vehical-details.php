...
<link href="https://fonts.googleapis.com/css?family=Lato:300,400,700,900" rel="stylesheet"><!-- jQuery UI for Datepicker -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>NLE<?php echo htmlentities($result->PricePerDay);?> </p>Per Day
...
<?php }} ?>
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="fromdate" id="fromdate" placeholder="From Date & Time" required>
    </div>
    <div class="form-group">
        <input type="text" class="form-control" name="todate" id="todate" placeholder="To Date & Time" required>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">NLE <?php echo htmlentities($result->PricePerDay);?></p>
...
</html>  Please  only one changes for me to this code,check if a vehicle number has been book and confirm before processing with booking