    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Cars For Rent</a></li>
        </ul>
      </div>
...
<span class="price">NLE <?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
